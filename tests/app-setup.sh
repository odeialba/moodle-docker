...
initcmd="bin/moodle-docker-compose exec -T webserver minstall behat -d lms"
...
then
    ...
    git clone --branch "v$MOODLE_DOCKER_APP_VERSION" --depth 1 git://github.com/moodlehq/moodle-local_moodlemobileapp $basedir/moodle/lms/local/moodlemobileapp
...
then
    ...
    git clone --branch "v$appversion" --depth 1 git://github.com/moodlehq/moodle-local_moodlemobileapp $basedir/moodle/lms/local/moodlemobileapp
else
